...
<div class="wrap">
    <h1>Pagina inserimento Luoghi</h1>
            ...
            <tr>
                ...
                <td>
                    <select name="dropdown" id="dropdown">
                            ...
                            <option value="Ceglie">Ceglie Messapica</option>
                            <option value="Carovigno">Carvigno</option>
                            <option value="Martina">Martina Franca</option>
